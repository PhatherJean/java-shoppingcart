...
public class CartItemServiceImplNoDBTest
{
    ...
    @MockBean
    private CartItemRepository cartIrepos;
    ...
    public void setUp() throws Exception
    {
        ...
        p1.setProductid(1);
        p1.setName("PEN");
        p1.setDescription("Makes Words Appear");
        p1.setPrice(2.50);
    ...
    {
        CartItemId cartIid = new CartItemId(1, 1);
        CartItem cart3 = new CartItem();
        ...
        Mockito.when(cartIrepos.findById(any(CartItemId.class))).thenReturn(Optional.of(cart3));
        Mockito.when(cartIrepos.save(any(CartItem.class))).thenReturn(cart3);
    ...
    public void emptyFromCart()
    {
        ...
        assertNull( cartItemService.removeFromCart(1L, 1L, "Bye").getQuantity());
